/* The following code was generated by JFlex 1.4.3 on 1/6/16 9:59 AM */
 ...
 * on 1/6/16 9:59 AM from the specification file
  ...
  public IRToken next_token() throws java.io.IOException, RuntimeException {
    ...
    while (true) {
      ...
      switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
        ...
        case 84: break;
        case 3: 
          { return new IRToken(yyline, McodeSym.LABEL, yytext());
          }
        case 85: break;
        case 48: 
        ...
        default: 
          if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
            ...
            zzDoEOF();
              {
                return new IRToken(yyline, McodeSym.EOF, null);
              }
          } 
          else {
